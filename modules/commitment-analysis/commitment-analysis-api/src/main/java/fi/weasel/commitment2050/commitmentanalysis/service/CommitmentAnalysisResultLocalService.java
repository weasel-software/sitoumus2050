...
/**
 * Provides the local service interface for CommitmentAnalysisResult. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CommitmentAnalysisResultLocalServiceUtil
...
public interface CommitmentAnalysisResultLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CommitmentAnalysisResultLocalServiceUtil} to access the commitment analysis result local service. Add custom service methods to {@link fi.weasel.commitment2050.commitmentanalysis.service.impl.CommitmentAnalysisResultLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public CommitmentAnalysisResult addCommitmentAnalysisResult(
	...
	*/
	public CommitmentAnalysisResult createCommitmentAnalysisResult(
		java.lang.String id);
	...
	*/
	...
	public CommitmentAnalysisResult deleteCommitmentAnalysisResult(
		CommitmentAnalysisResult commitmentAnalysisResult);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public CommitmentAnalysisResult deleteCommitmentAnalysisResult(
		java.lang.String id) throws PortalException;
	...
	*/
	...
	public CommitmentAnalysisResult fetchCommitmentAnalysisResult(
		java.lang.String id);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<java.lang.String> getCAResultTypes();
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CommitmentAnalysisResult getCommitmentAnalysisResult(
		java.lang.String id) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CommitmentAnalysisResult> getCommitmentAnalysisResults(
		int start, int end);
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CommitmentAnalysisResult getResultByResultType(
		java.lang.String resultType);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<List<java.lang.String>> getTopLifestyleCommitments();
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public CommitmentAnalysisResult updateCommitmentAnalysisResult(
		CommitmentAnalysisResult commitmentAnalysisResult);
}