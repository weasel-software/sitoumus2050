...
/**
 * Provides the local service interface for Operation. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see OperationLocalServiceUtil
...
public interface OperationLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link OperationLocalServiceUtil} to access the operation local service. Add custom service methods to {@link fi.weasel.commitment2050.commitmentanalysis.service.impl.OperationLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public Operation createOperation(java.lang.String id);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Operation deleteOperation(java.lang.String id)
	...
	*/
	...
	public Operation fetchOperation(java.lang.String id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Operation getOperation(java.lang.String id)
		throws PortalException;
	...
	*/
	...
	public Operation operationFromJSONObject(java.lang.String commitmentID,
		JSONObject o);

	public List<Operation> operationsFromJSONArray(
