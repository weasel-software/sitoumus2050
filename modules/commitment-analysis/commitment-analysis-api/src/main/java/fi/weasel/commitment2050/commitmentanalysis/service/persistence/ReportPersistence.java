...
public interface ReportPersistence extends BasePersistence<Report> {
	...
	*/
	public Report create(java.lang.String id);
	...
	*/
	public Report remove(java.lang.String id) throws NoSuchReportException;
	...
	* @throws NoSuchReportException if a report with the primary key could not be found
	*/
	public Report findByPrimaryKey(java.lang.String id)
	...
	*/
	public Report fetchByPrimaryKey(java.lang.String id);
