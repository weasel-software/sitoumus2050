...
/**
 * The persistence utility for the operation service. This utility wraps {@link fi.weasel.commitment2050.commitmentanalysis.service.persistence.impl.OperationPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class OperationUtil {
	...
	*/
	public static Operation create(java.lang.String id) {
	...
	*/
	public static Operation remove(java.lang.String id)
		throws fi.weasel.commitment2050.commitmentanalysis.exception.NoSuchOperationException {
	...
	* @throws NoSuchOperationException if a operation with the primary key could not be found
	*/
	public static Operation findByPrimaryKey(java.lang.String id)
		throws fi.weasel.commitment2050.commitmentanalysis.exception.NoSuchOperationException {
	...
	*/
	public static Operation fetchByPrimaryKey(java.lang.String id) {
		return getPersistence().fetchByPrimaryKey(id);
	}

	public static java.util.Map<java.io.Serializable, Operation> fetchByPrimaryKeys(
	...
	*/
	...
	private static ServiceTracker<OperationPersistence, OperationPersistence> _serviceTracker =
		ServiceTrackerFactory.open(OperationPersistence.class);
}