...
/**
 * Provides the local service interface for DoneOperation. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DoneOperationLocalServiceUtil
...
public interface DoneOperationLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DoneOperationLocalServiceUtil} to access the done operation local service. Add custom service methods to {@link fi.weasel.commitment2050.commitmentanalysis.service.impl.DoneOperationLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public DoneOperation createDoneOperation(java.lang.String id);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public DoneOperation deleteDoneOperation(java.lang.String id)
	...
	*/
	...
	public DoneOperation doneOperationFromJSONObject(
		java.lang.String commitmentID, JSONObject o);

	public List<DoneOperation> doneOperationsFromJSONArray(
		java.lang.String commitmentID, JSONArray a);
	...
	*/
	...
	public DoneOperation fetchDoneOperation(java.lang.String id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DoneOperation getDoneOperation(java.lang.String id)
		throws PortalException;
