...
import fi.weasel.commitment2050.commitmentanalysis.service.CommitmentLocalService;
...
/**
 * Provides the base implementation for the commitment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link fi.weasel.commitment2050.commitmentanalysis.service.impl.CommitmentLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class CommitmentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CommitmentLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link fi.weasel.commitment2050.commitmentanalysis.service.CommitmentLocalServiceUtil} to access the commitment local service.
	 */
	...
	public Commitment addCommitment(Commitment commitment) {
		...
		return commitmentPersistence.update(commitment);
	}
	 ...
	 */
	@Override
	public Commitment createCommitment(String commitmentId) {
		return commitmentPersistence.create(commitmentId);
	}
	...
	public Commitment deleteCommitment(String commitmentId)
		...
		return commitmentPersistence.remove(commitmentId);
	}
	...
	public Commitment deleteCommitment(Commitment commitment) {
		return commitmentPersistence.remove(commitment);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Commitment.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return commitmentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return commitmentPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return commitmentPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public Commitment fetchCommitment(String commitmentId) {
		return commitmentPersistence.fetchByPrimaryKey(commitmentId);
	}
	...
	public Commitment getCommitment(String commitmentId)
		throws PortalException {
		return commitmentPersistence.findByPrimaryKey(commitmentId);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return commitmentLocalService.deleteCommitment((Commitment)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return commitmentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Commitment> getCommitments(int start, int end) {
		return commitmentPersistence.findAll(start, end);
	}
	...
	public int getCommitmentsCount() {
		return commitmentPersistence.countAll();
	}
	 ...
	 */
	public CommitmentLocalService getCommitmentLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("fi.weasel.commitment2050.commitmentanalysis.model.Commitment",
			commitmentLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return CommitmentLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = commitmentPersistence.getDataSource();
	...
	@BeanReference(type = CommitmentLocalService.class)
	protected CommitmentLocalService commitmentLocalService;
