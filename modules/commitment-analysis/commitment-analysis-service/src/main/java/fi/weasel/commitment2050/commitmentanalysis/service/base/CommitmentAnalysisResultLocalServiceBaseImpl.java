...
import fi.weasel.commitment2050.commitmentanalysis.service.CommitmentAnalysisResultLocalService;
...
/**
 * Provides the base implementation for the commitment analysis result local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link fi.weasel.commitment2050.commitmentanalysis.service.impl.CommitmentAnalysisResultLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class CommitmentAnalysisResultLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CommitmentAnalysisResultLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link fi.weasel.commitment2050.commitmentanalysis.service.CommitmentAnalysisResultLocalServiceUtil} to access the commitment analysis result local service.
	 */
	...
	public CommitmentAnalysisResult addCommitmentAnalysisResult(
		...
		return commitmentAnalysisResultPersistence.update(commitmentAnalysisResult);
	}
	 ...
	 */
	@Override
	public CommitmentAnalysisResult createCommitmentAnalysisResult(String id) {
		return commitmentAnalysisResultPersistence.create(id);
	}
	...
	@Override
	public CommitmentAnalysisResult deleteCommitmentAnalysisResult(String id)
		throws PortalException {
		return commitmentAnalysisResultPersistence.remove(id);
	}
	...
	public CommitmentAnalysisResult deleteCommitmentAnalysisResult(
		CommitmentAnalysisResult commitmentAnalysisResult) {
		return commitmentAnalysisResultPersistence.remove(commitmentAnalysisResult);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CommitmentAnalysisResult.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return commitmentAnalysisResultPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return commitmentAnalysisResultPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public CommitmentAnalysisResult fetchCommitmentAnalysisResult(String id) {
		return commitmentAnalysisResultPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public CommitmentAnalysisResult getCommitmentAnalysisResult(String id)
		throws PortalException {
		return commitmentAnalysisResultPersistence.findByPrimaryKey(id);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return commitmentAnalysisResultLocalService.deleteCommitmentAnalysisResult((CommitmentAnalysisResult)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return commitmentAnalysisResultPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<CommitmentAnalysisResult> getCommitmentAnalysisResults(
		int start, int end) {
		return commitmentAnalysisResultPersistence.findAll(start, end);
	}
	...
	public int getCommitmentAnalysisResultsCount() {
		return commitmentAnalysisResultPersistence.countAll();
	}
	 ...
	 */
	public CommitmentAnalysisResultLocalService getCommitmentAnalysisResultLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("fi.weasel.commitment2050.commitmentanalysis.model.CommitmentAnalysisResult",
			commitmentAnalysisResultLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return CommitmentAnalysisResultLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = commitmentAnalysisResultPersistence.getDataSource();
	...
	@BeanReference(type = CommitmentAnalysisResultLocalService.class)
	protected CommitmentAnalysisResultLocalService commitmentAnalysisResultLocalService;
