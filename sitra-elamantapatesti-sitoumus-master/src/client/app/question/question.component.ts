...
@Component({
  ...
  animations: [
    trigger('slide', [
      ...
      transition('enter => in', animate('0ms ease-out')),
      transition('in => leave', animate('0ms ease-in')),
      transition('leave => in', animate('0ms ease-out')),
      transition('in => enter', animate('0ms ease-in')),
    ]),
  ],
})
